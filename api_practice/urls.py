...
urlpatterns = [
    ...
    url(r'^api/:packers-player/$', PackersPlayerListCreateAPIView.as_view(), name="packers_list_api_view"),
    url(r'^api/:packers-player/(?P<pk>\d+)/$', PackersPlayerDetailUpdateDestroyAPIView.as_view(), name="packers_detail_api_view"),
]
